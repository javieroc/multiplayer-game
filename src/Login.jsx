        ...
        <div className="fluorescent-panel">
          <form onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label>Email</label>
              <input className="form-control custom-input" type="text" placeholder="Email" ref={(email) => {this.email = email;}} />
            </div>
            <div className="form-group">
              <label>Password</label>
              <input className="form-control custom-input" type="password" placeholder="Password" ref={(password) => {this.password = password;}} />
            </div>
            {
